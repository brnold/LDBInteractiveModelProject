import Threshold, Baselines, ObjI2C, time, os
...
# MPR121 - thresholds
	...
	def displayCount(self):
		...
		time.sleep(0.01)
		ObjI2C.I2CWriteBytes(self.ChipAddress, Threshold.ThresholdAll[0][3])
		ObjI2C.I2CWriteBytes(self.ChipAddress, TouchObj.ucELE0_11cdt)
		ObjI2C.I2CWriteBytes(self.ChipAddress, TouchObj.ucELE0_11cc)
		ObjI2C.I2CWriteBytes(self.ChipAddress, Baselines.BaselineAll[0][1])
#		ObjI2C.I2CWriteBytes(self.ChipAddress, TouchObj.ucBaseLine)
	...
	def displayStatus(self):
		self.TouchStatus = ObjI2C.I2CReadStatus(self.ChipAddress)
#		print self.TouchStatus
